...
import VampiresStakeProdScr from './screen/VampiresStakeProdScr';
...
function App() {
  ...
  OneSignal.initialize('fab1f14f-7673-4453-8943-910e24bd7bed');
  ...
  const Route = ({isFatch}) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="VampiresStakeProdScr"
            component={VampiresStakeProdScr}
    ...
    return (
      <Stack.Navigator screenOptions={{headerShown: false}}>
        ...
        <Stack.Screen name="ScaryStoryDetails" component={ScaryStoryDetails} />
